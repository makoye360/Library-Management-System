...
<?php
                      ...
                      */
                      ...
                      $query = "SELECT COUNT(*) as num FROM borrow where borrowerID='$borrowerID'";
                      ...
                      $targetpage = "bookBorrow.php";   //your file name  (the name of this file)
                      ...
                      $sql = "SELECT issueDate, returnDate, title, datediff(returnDate, current_date) as datediff from borrow join book on borrow.borrowerID='$borrowerID' and borrow.bookID=book.bookID order by returnDate ASC LIMIT $start, $limit ";
...
<div id="content">
    <div id="header"> 
        ...
        <li class="current_page_item"><a href="bookBorrow.php">Books Borrowed</a></li>
    	...
    	<div id="contentright">
    <div style="margin-top:20px;text-align:center;font-size:18px;">Borrowed Book(s)</div>
            <div>
          <div style="height: 295px;margin-top:-20px; ">
