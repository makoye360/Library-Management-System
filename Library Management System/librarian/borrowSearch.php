 ...
 <title>Library Management System</title>
  ...
  <?php
                      ...
                      */
                      ...
                      $query = "SELECT COUNT(*) as num FROM borrow WHERE borrowerID LIKE '%".$_GET["search"]."%' OR bookID LIKE '%".$_GET["search"]."%' ";
                      ...
                      $targetpage = "borrowSearch.php?search=$getSearch";   //your file name  (the name of this file)
                      ...
                      $sql = "SELECT *, datediff(returnDate, current_date) as datediff FROM borrow WHERE borrowerID LIKE '%".$_GET["search"]."%' OR bookID LIKE '%".$_GET["search"]."%' ORDER BY returnDate DESC LIMIT $start, $limit ";
...
<div id="content">
    <div id="header"> 
      ...
      <div id="contentright">
          ...
          <input name="search" type="text" placeholder="Search for BorrowerID or bookID"  id="search" value="<?php if(isset($_GET['search'])) echo $_GET['search']; ?>">
