 ...
 <title>Library Management System</title>
  ...
  <?php
                      ...
                      */
                      ...
                      $query = "SELECT COUNT(*) as num FROM book WHERE title LIKE '%".$_GET["search"]."%' OR author LIKE '%".$_GET["search"]."%' OR publisher LIKE '%".$_GET["search"]."%' ";
                      ...
                      $sql = "SELECT * FROM book WHERE title LIKE '%".$_GET["search"]."%' OR author LIKE '%".$_GET["search"]."%' OR publisher LIKE '%".$_GET["search"]."%' ORDER BY bookID DESC LIMIT $start, $limit ";
...
<div id="content">
    <div id="header"> 
    	...
    	<div id="contentright">
          ...
          <input name="search" type="text" placeholder="Search for title or author or publisher"  id="search" value="<?php if(isset($_GET['search'])) echo $_GET['search']; ?>">
          <input type="submit" value="Search" id="search_button"> 
          </form>
          </div>
          <div class="add"> <a href="bookForm.php"><img title="Add Book" alt="Add Book" src="../img/data_add.png" style="width: 25px;height:25px;" /></a> </div>
          </div>
                      ...
                      <tbody>
                         <?php
                          ...
                          <tr>
                            ...
                            <td>
                            <span><a href="bookEdit.php?id=<?php echo $row['bookID']; ?>"><img height="18px" width="18px" src="../img/edit-icon.png"></a></span>
                            &nbsp;&nbsp;
                             <span><a onclick="return confirmSubmit()" href="bookDelete.php?id=<?php echo $row['bookID']; ?>"><img height="18px" width="18px" src="../img/delete.png"></a></span>
                              </td>
                          </tr>
                            <?php } ?>
                      </tbody>
