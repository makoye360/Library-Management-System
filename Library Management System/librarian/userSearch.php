...
<?php
                      ...
                      */
                      ...
                      $query = "SELECT COUNT(*) as num FROM userLogin WHERE username LIKE '%".$_GET["search"]."%' OR level LIKE '%".$_GET["search"]."%' OR memberID LIKE '%".$_GET["search"]."%' ";
                      ...
                      $targetpage = "userSearch.php?search=$getSearch";   //your file name  (the name of this file)
                      ...
                      $sql = "SELECT * FROM userLogin WHERE username LIKE '%".$_GET["search"]."%' OR level LIKE '%".$_GET["search"]."%' OR memberID LIKE '%".$_GET["search"]."%' ORDER BY userID DESC LIMIT $start, $limit ";
...
<div id="content">
    <div id="header"> 
    	...
    	<div id="contentright">
          ...
          <input name="search" type="text" placeholder="Search..."  id="search" value="<?php if(isset($_GET['search'])) echo $_GET['search']; ?>">
