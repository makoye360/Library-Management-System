 ...
 <title>Library Management System</title>
  ...
  <?php
                      ...
                      */
                      ...
                      $query = "SELECT COUNT(*) as num FROM book";
                      ...
                      $targetpage = "bookInfo.php";   //your file name  (the name of this file)
                      ...
                      $sql = "SELECT * FROM  book ORDER BY bookID DESC LIMIT $start, $limit ";
...
<div id="content">
    <div id="header"> 
    	...
    	<div id="contentright">
          ...
          <input name="search" type="text" placeholder="Search for title or author or publisher"  id="search">
